...
2sb8wy.euialqfpxfbcljby   23h       2020-02-08T15:36:30+08:00   authentication,signing   kubelet-bootstrap-token   system:bootstrappers:nic-k8s-02
ta7onm.fcen74h0mczyfbz2   23h       2020-02-08T15:36:30+08:00   authentication,signing   kubelet-bootstrap-token   system:bootstrappers:nic-k8s-01
xk27zp.tylnvywx9kc8sq87   23h       2020-02-08T15:36:30+08:00   authentication,signing   kubelet-bootstrap-token   system:bootstrappers:nic-k8s-03
```
...
csr-5rwzm   43s   system:node:nic-k8s-01   Pending
csr-65nms   55s   system:bootstrap:2sb8wy       Approved,Issued
csr-8t5hj   42s   system:node:nic-k8s-02   Pending
csr-jkhhs   41s   system:node:nic-k8s-03   Pending
...
nic-k8s-01   NotReady   <none>   10h   v1.16.6
nic-k8s-02   NotReady   <none>   10h   v1.16.6
nic-k8s-03   NotReady   <none>   10h   v1.16.6
```
...
$ kubectl get csr
NAME        AGE     REQUESTOR                     CONDITION
csr-5rwzm   3m22s   system:node:nic-k8s-01   Pending
csr-65nms   3m34s   system:bootstrap:2sb8wy       Approved,Issued
csr-8t5hj   3m21s   system:node:nic-k8s-02   Pending
csr-jkhhs   3m20s   system:node:nic-k8s-03   Pending
